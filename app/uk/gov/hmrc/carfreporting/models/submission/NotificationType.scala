...
enum NotificationType:
  case FileReady, FileReceived, FileProcessed, FileProcessingFailure

object NotificationType {
  given Writes[NotificationType] = Writes[NotificationType] {
  ...
  given Reads[NotificationType] = Reads[NotificationType] {
    ...
    case other                             =>
      JsError(s"Invalid SdesCallback: $other")
  }
}
