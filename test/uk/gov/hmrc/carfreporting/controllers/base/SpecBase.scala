...
package uk.gov.hmrc.carfreporting.controllers.base
...
import uk.gov.hmrc.carfreporting.dispatchers.{DispatcherName, MainDispatcherName}
...
trait SpecBase
  ...
  override def fakeApplication(): Application =
    GuiceApplicationBuilder()
      .overrides(
        bind[DispatcherName].toInstance(new MainDispatcherName())
      )
      .build()
